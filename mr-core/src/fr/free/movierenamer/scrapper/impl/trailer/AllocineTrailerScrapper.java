...
/**
 * Class AllocineTrailerScrapper
 *
 * @author Nicolas Magré
 */
public class AllocineTrailerScrapper extends TrailerScrapper {
  ...
  protected List<Trailer> searchTrailer(Media media) throws Exception {
    ...
    // Get id
    IdInfo id = ScrapperUtils.idLookup(AvailableApiIds.ALLOCINE, null, media);
    if (id == null) {
      return trailers;
    }
