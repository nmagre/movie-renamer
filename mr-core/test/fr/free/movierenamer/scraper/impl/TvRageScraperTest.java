...
/**
 * Class TvRageScraperTest
 *
 * @author Simon QUÉMÉNEUR
 */
public final class TvRageScraperTest extends TvShowScraperTest {

  private TvRageScraper tvrage = null;

  @Override
  public void init() {
    tvrage = new TvRageScraper();
  }
  ...
  public void getTvShowInfo() throws Exception {
    TvShowInfo tvShow = tvrage.getInfo(new TvShow(null, new IdInfo(27811, ScraperUtils.AvailableApiIds.TVRAGE), null, null, -1));
  ...
  public void getCasting() throws Exception {
    List<CastingInfo> cast = tvrage.getCasting(new TvShow(null, new IdInfo(2930, ScraperUtils.AvailableApiIds.TVRAGE), null, null, -1), new IdInfo(2930, ScraperUtils.AvailableApiIds.TVRAGE));
  ...
  public void getImages() throws Exception {
    List<ImageInfo> images = tvrage.getImages(new TvShow(null, new IdInfo(1858, ScraperUtils.AvailableApiIds.TVRAGE), null, null, -1));
