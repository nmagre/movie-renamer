...
import fr.free.movierenamer.scraper.impl.movie.AnidbScraper;
import org.junit.Assert;

import fr.free.movierenamer.scraper.MovieScraperTest;

/**
 * Class AnidbScraperTest
 *
 * @author Simon QUÉMÉNEUR
 */
public class AnidbScraperTest extends MovieScraperTest {
  private AnidbScraper anidb = null;

  @Override
  public void init() {
    anidb = new AnidbScraper();
  }
