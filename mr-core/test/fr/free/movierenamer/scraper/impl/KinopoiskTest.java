 ...
 */
public class KinopoiskTest extends MovieScraperTest {

  private KinopoiskScraper kinopoist = null;

  @Override
  public void init() {
    kinopoist = new KinopoiskScraper();
  }
...
//    Assert.assertEquals(301, movie.getMediaId().getId());
  ...
  public void getMovieInfo() throws Exception {
    MovieInfo movie = kinopoist.getInfo(new Movie(null, new IdInfo(251733, ScraperUtils.AvailableApiIds.KINOPOISK), null, null, null, -1));
  }
