...
import fr.free.movierenamer.scraper.ImageScraperTest;
 ...
 */
public class FanartTVTest extends ImageScraperTest {

  private FanartTVImagesScraper fanarttv = null;

  @Override
  public void init() {
    fanarttv = new FanartTVImagesScraper();
  }

  @Override
  public void getImages() throws Exception {
    List<ImageInfo> images = fanarttv.getImages(new Movie(null, new IdInfo(19995, ScraperUtils.AvailableApiIds.THEMOVIEDB), null, null, null, -1));
