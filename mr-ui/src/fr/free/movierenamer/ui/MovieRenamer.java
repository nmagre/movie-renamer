...
//        fileFormatField.setText(tvshowFileFormat);
    ...
    private void searchMediaInfo(UISearchResult searchResult) {
        ...
        // Stop all running workers except search result list image worker
    ...
    private void initComponents() {
        ...
        mediaLbl.setFont(new Font("Ubuntu", 1, 13));
        ...
        mediaFilePnlLayout.setHorizontalGroup(
            ...
            .addComponent(mediaFileTb, GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
        ...
        searchLbl.setFont(new Font("Ubuntu", 1, 13));
