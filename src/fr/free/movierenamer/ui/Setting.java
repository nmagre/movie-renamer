...
public class Setting extends JDialog {
  ...
  private void initComponents() {
    ...
    extensionPnlLayout.setHorizontalGroup(
      ...
      .addGroup(extensionPnlLayout.createSequentialGroup()
        ...
        .addGroup(extensionPnlLayout.createParallelGroup(Alignment.LEADING)
          ...
          .addComponent(extensionScrollP, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE))
        .addPreferredGap(ComponentPlacement.UNRELATED)
      ...
      .addGroup(fileNameFilterPnlLayout.createSequentialGroup()
        ...
        .addGroup(fileNameFilterPnlLayout.createParallelGroup(Alignment.LEADING)
          .addGroup(fileNameFilterPnlLayout.createSequentialGroup()
            ...
            .addGap(12, 12, 12))
          .addGroup(fileNameFilterPnlLayout.createSequentialGroup()
            .addComponent(filterScrollP, GroupLayout.DEFAULT_SIZE, 360, Short.MAX_VALUE)
            .addPreferredGap(ComponentPlacement.UNRELATED)))
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(Alignment.TRAILING, layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(Alignment.TRAILING)
          .addComponent(settingTabPan, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 461, Short.MAX_VALUE)
    ...
    layout.setVerticalGroup(
      ...
      .addGroup(Alignment.TRAILING, layout.createSequentialGroup()
        .addContainerGap()
        .addComponent(settingTabPan, GroupLayout.DEFAULT_SIZE, 445, Short.MAX_VALUE)
        .addGap(18, 18, 18)
