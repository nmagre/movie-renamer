...
public final class Settings {
  ...
  // images
  public static final Icon MEDIARENAMEDICON = new ImageIcon(ImageUtils.getImageFromJAR("icon-32.png"));
  public static final Icon MEDIAWASRENAMEDICON = new ImageIcon(ImageUtils.getImageFromJAR("icon-22.png"));
  public static final Icon MEDIAICON = new ImageIcon(ImageUtils.getImageFromJAR("film.png"));
  public static final Icon MEDIAWARNINGICON = new ImageIcon(ImageUtils.getImageFromJAR("film-error.png"));
  ...
  private Settings loadSetting() throws SettingsSaveFailedException {
    ...
    try {
      ...
      Document xml = WebRequest.getXmlDocument(file.toURI().toURL());
