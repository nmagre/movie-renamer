 ...
 */
public class ImdbImageWorker extends MediaImageWorker<MovieImage> {
   ...
   */
  public ImdbImageWorker(PropertyChangeSupport errorSupport, MediaID id) throws ActionNotValidException {
